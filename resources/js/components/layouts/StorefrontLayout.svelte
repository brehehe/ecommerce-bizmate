            ...
            <div class="p-4 sm:p-6 overflow-y-auto overscroll-contain flex-1">
                ...
                {#if authTab === 'login'}
                    <div transition:fade={{ duration: 150 }}>
                        <h2
                            class="text-lg sm:text-xl font-outfit font-black text-slate-800 mb-1"
                        >
                        ...
                        <div class="mb-4">
                            <p class="text-[11px] sm:text-xs font-semibold text-slate-500 mb-2">
                                Masuk dengan
                            </p>
                            <div class="grid {isPadelgigsLoginEnabled ? 'grid-cols-2' : 'grid-cols-1'} gap-2.5">
                                {#if isPadelgigsLoginEnabled}
                                    <!-- PadelGigs SSO Button -->
                                    <a
                                        href="/auth/padelgigs"
                                        class="flex items-center justify-center gap-2 py-2.5 px-3 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 text-slate-700 font-semibold text-xs sm:text-sm rounded-xl shadow-xs transition-all active:scale-[0.98] group no-underline"
                                    >
                                        <img
                                            src="/logo/Logo-padelgigs-bunder-hitam.png"
                                            alt="PadelGigs"
                                            class="w-4 h-4 shrink-0 object-contain group-hover:scale-110 transition-transform"
                                        />
                                        <span class="font-outfit text-slate-700 group-hover:text-slate-900">PadelGigs</span>
                                    </a>
                                {/if}
                                <!-- Google SSO Button -->
                                <a
                                ...
                                >
                                    ...
                                    <span class="font-outfit text-slate-700 group-hover:text-slate-900">{isPadelgigsLoginEnabled ? 'Google' : 'Masuk dengan Google'}</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid {isPadelgigsLoginEnabled ? 'grid-cols-2' : 'grid-cols-1'} gap-2.5">
                                ...
                                >
                                    ...
                                    <span class="font-outfit text-slate-700 group-hover:text-slate-900">{isPadelgigsLoginEnabled ? 'Google' : 'Daftar dengan Google'}</span>
                                </a>
                            </div>
                        </div>
