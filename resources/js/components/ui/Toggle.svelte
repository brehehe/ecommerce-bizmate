...
<div class="flex items-center justify-between gap-6 p-3 rounded-2xl border border-slate-100 hover:bg-slate-50 transition cursor-pointer" onclick={() => checked = !checked}>
