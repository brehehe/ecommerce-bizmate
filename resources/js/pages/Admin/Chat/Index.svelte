...
<AdminLayout>
    ...
    >
        ...
        >
            ...
            <div
                class="w-full md:w-85 border-r border-slate-200 flex flex-col shrink-0 min-h-0"
            >
                <!-- Search bar -->
                <div
            ...
            <div
                class="flex-grow flex flex-col bg-slate-50/50 min-h-0 w-full md:w-auto min-w-0 hidden md:flex"
            >
                <!-- Top Toolbar Placeholder Header to match search bar height -->
                <div
                    class="bg-white border-b border-slate-200 h-[65px] shrink-0 w-full"
                ></div>

                <div
                    class="flex-grow flex flex-col justify-center items-center text-center p-8"
                >
                    <div
                        class="w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-sm mb-4 text-slate-300"
                    >
                        <i class="ti ti-brand-hipchat text-4xl"></i>
                    </div>
                    <h2
                        class="text-slate-800 font-outfit font-black text-base mb-1"
                    >
                        Pusat Pesan Pelanggan
                    </h2>
                    <p class="text-slate-400 text-xs max-w-xs leading-relaxed">
                        Silakan klik salah satu daftar obrolan di sebelah kiri
                        untuk melihat pesan dan mulai membalas chat pelanggan
                        secara realtime.
                    </p>
                </div>
            </div>
