            ...
            >
                ...
                {:else}
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse responsive-table admins-table">
                            <thead>
                                <tr
                            ...
                            >
                                {#each users.data as admin (admin.id)}
                                    ...
                                    >
                                        ...
                                        <!-- User info -->
                                        <td class="py-4 px-6" data-label="Pengguna Admin">
                                            <div
                                        ...
                                        <!-- Role badge -->
                                        <td class="py-4 px-6" data-label="Hak Akses">
                                            <span
                                        ...
                                        <!-- Phone -->
                                        <td class="py-4 px-6" data-label="No. HP">
                                        ...
                                        <!-- Join date -->
                                        <td class="py-4 px-6" data-label="Bergabung">
                                            <span
                                        ...
                                        <!-- Last active -->
                                        <td class="py-4 px-6" data-label="Terakhir Aktif">
                                            <span
...
<style>
    @media (max-width: 640px) {
        ...
        .admins-table td[data-label="Pengguna Admin"] {
