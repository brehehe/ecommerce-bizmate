        ...
        router.post(
            ...
            },
            {
                ...
                onError: (err) => {
                    const first =
                        Object.values(err)[0] ||
                        'Gagal menghapus pelanggan terpilih.';
            ...
            >
                ...
                {:else}
                    <div class="overflow-visible">
                        <table class="w-full text-left border-collapse responsive-table customers-table">
                            <thead>
                                <tr
                                ...
                                >
                                    ...
                                    <th class="py-4 px-6 hidden lg:table-cell">No. HP</th>
                                    <th class="py-4 px-6 hidden md:table-cell">Gender / Usia</th>
                                    <th class="py-4 px-6 text-center">Transaksi</th>
                                    <th class="py-4 px-6 text-center hidden xl:table-cell">Koin</th>
                                    <th class="py-4 px-6 hidden xl:table-cell">Bergabung</th>
                                    <th class="py-4 px-6 hidden lg:table-cell">Terakhir Aktif</th>
                                    ...
                                    >
                                        ...
                                        <td class="py-4 px-6" data-label="Pelanggan">
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <p
                                                        class="text-sm font-bold text-slate-800 leading-tight text-left"
                                                    >
                                                        {customer.name}
                                                    </p>
                                                    <p
                                                        class="text-[11px] text-slate-400 mt-0.5 text-left"
                                                    >
                                                        {customer.email}
                                                    </p>
                                                </div>
                                        ...
                                        <!-- Phone -->
                                        <td class="py-4 px-6 hidden lg:table-cell" data-label="No. HP">
                                        ...
                                        <!-- Gender / Age -->
                                        <td class="py-4 px-6 hidden md:table-cell" data-label="Gender / Usia">
                                            {#if genderInfo}
                                                <div
                                                    class="flex flex-col gap-0.5 animate-none"
                                                >
                                                    <span
                                        ...
                                        <!-- Transactions count -->
                                        <td class="py-4 px-6 text-center" data-label="Transaksi">
                                            <span
                                        ...
                                        <!-- Coins -->
                                        <td class="py-4 px-6 text-center hidden xl:table-cell" data-label="Koin">
                                        ...
                                        <!-- Join date -->
                                        <td class="py-4 px-6 hidden xl:table-cell" data-label="Bergabung">
                                            <span
                                        ...
                                        <!-- Last active -->
                                        <td class="py-4 px-6 hidden lg:table-cell" data-label="Terakhir Aktif">
                                            <span
                                        ...
                                        <td class="py-4 px-6 text-center" data-label="Aksi">
                                            <div class="relative inline-block">
                                                ...
                                                {#if openMenuId === customer.id}
                                                    ...
                                                    <div
                                                        role="menu"
                                                        class="absolute right-0 z-50 bg-white border border-slate-200 rounded-2xl shadow-xl py-1.5 w-48 overflow-hidden {menuAbove ? 'bottom-full mb-1' : 'top-full mt-1'}"
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            ...
                                                            class="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm transition text-left {isActive ? 'text-amber-600 hover:bg-amber-50' : 'text-emerald-600 hover:bg-emerald-50'}"
                                                        >
...
<style>
    @media (max-width: 640px) {
        ...
        .customers-table td[data-label="Pelanggan"] {
        ...
        /* Ensure Aksi td is not clipped so dropdown shows */
        .customers-table td[data-label="Aksi"] {
            overflow: visible !important;
            position: relative;
        }
    }
    /* Desktop: ensure table allows overflow for dropdown */
    .customers-table {
        overflow: visible !important;
    }
    .customers-table td[data-label="Aksi"] {
        ...
        >
            ...
            <p class="text-sm text-center text-slate-550 font-medium mb-8">
                Apakah Anda yakin ingin menghapus <strong
                    >{selectedCustomers.length} pelanggan</strong
