            ...
            >
                ...
                {:else}
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse responsive-table social-media-table">
                            <thead>
                                <tr
                            ...
                            >
                                {#each socialMediaLinks.data as item (item.id)}
                                    ...
                                    >
                                        ...
                                        <td class="py-5 px-4 text-center" data-label="Urut">
                                            <div
                                                class="flex items-center justify-center animate-none"
                                            >
                                                <i
                                        ...
                                        <td class="py-5 px-6" data-label="Platform">
                                            <div
                                                class="flex items-center gap-3"
                                            >
                                                <div
                                                    class="w-10 h-10 rounded-xl flex items-center justify-center text-white shrink-0 animate-none"
                                                ...
                                                <span
                                                    class="font-bold text-slate-800 text-sm text-left"
                                                >
                                                    {getPlatformName(
                                                        item.platform,
                                                    )}
                                        ...
                                        <td class="py-5 px-6" data-label="Label">
                                            <span
                                                class="font-semibold text-slate-700 text-left"
                                                >{item.label}</span
                                            >
                                        </td>
                                        <td class="py-5 px-6" data-label="URL / Handle">
                                            <a
                                        ...
                                        <td class="py-5 px-6" data-label="Status">
                                            <span
                                        ...
                                        <td class="py-5 px-6 text-center" data-label="Aksi">
                                            <div
...
<style>
    @media (max-width: 640px) {
        .social-media-table td:nth-child(3) {
            display: flex !important;
        }
        .social-media-table td[data-label="Platform"] {
