<script lang="ts">
    ...
    const form = useForm({
        ...
        settings: {
            ...
            show_publicly: true,
            points_new_user: '',
            points_existing_user: '',
            bundle: {
                buy_items: [{ product_id: '', product_variant_id: '', qty: 1 }],
                get_items: [
                    {
                        product_id: '',
                        product_variant_id: '',
...
<AdminLayout>
    <main class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-6 space-y-5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-semibold tracking-tight text-slate-900 font-sans">Buat Promosi Baru</h1>
                <p class="mt-0.5 text-sm text-slate-500 font-sans">Isi detail parameter promosi di bawah ini</p>
            </div>
        </div>
