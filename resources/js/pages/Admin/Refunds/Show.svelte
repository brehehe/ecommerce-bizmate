        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                >
                    ...
                    <div class="p-3 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">
                            Grand Total: <strong
                                >{fmt(refund.transaction?.grand_total)}</strong
                            >
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    <p
                        class="text-sm text-slate-700 bg-slate-50 rounded-xl p-4 leading-relaxed whitespace-pre-line"
                    >
                        {refund.reason}
                    </p>
                    ...
                    {#if refund.notes_admin}
                        ...
                        >
                            ...
                            <p
                                class="text-sm text-amber-800 whitespace-pre-line"
                            >
                                {refund.notes_admin}
                            </p>
                        </div>
                ...
                {#if refund.transaction && refund.transaction.items}
                    ...
                    >
                        <h4
                            class="font-bold text-slate-800 text-sm mb-4 flex items-center gap-2"
                        >
                            <i class="ti ti-package text-base text-slate-400"
                            ></i> Produk Pesanan
                        </h4>
                        <div class="space-y-3">
                            {#each refund.transaction.items as item (item.id)}
                                ...
                                >
                                    ...
                                    >
                                        <i class="ti ti-package text-slate-400"
                                        ></i>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p
                                            class="text-sm font-bold text-slate-800 leading-tight truncate"
                                        >
                                            {item.product_name}
                                        </p>
                                        {#if item.variant_name}
                                            <span
                                                class="text-[10px] font-bold text-slate-505 bg-white border border-slate-200 px-1.5 py-0.5 rounded mt-0.5 inline-block"
                                    ...
                                    <div class="text-right shrink-0">
                                        ...
                                        <p
                                            class="text-sm font-black text-slate-850"
                                        >
                                            {fmt(
                                                item.harga_akhir ??
                                                    item.harga_jual,
                        ...
                        >
                            <span class="text-sm font-bold text-slate-500"
                                >Total Nominal Refund</span
                            >
                            <span
                                class="text-lg font-black"
                                style="color:{primary}"
                                >{fmt(refund.refund_amount)}</span
                            >
                        </div>
                    </div>
                {/if}
            ...
            <div class="space-y-5">
                ...
                <div
                    class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl border border-cyan-250 p-5 space-y-3"
                >
                    <h4
                        class="font-bold text-cyan-850 text-sm flex items-center gap-2"
                    >
                        <i class="ti ti-wallet text-base"></i> Detail Pengembalian
                        Dana
                    </h4>

                    {#if refund.refund_method === 'transfer'}
                        <div
                            class="bg-white rounded-xl p-4 border border-cyan-200 space-y-3"
                        >
                            <div>
                                <p
                            ...
                            <div>
                                ...
                                <p
                                    class="font-mono font-bold text-lg text-slate-900 mt-0.5 tracking-wider"
                                >
                            ...
                            <div>
                                ...
                                <p
                                    class="font-bold text-slate-800 text-sm mt-0.5"
                                >
                                    {refund.account_name}
                                </p>
                            </div>
                    ...
                    {:else}
                        ...
                        >
                            ...
                            >
                                Refund akan dikreditkan secara instan ke saldo
                                koin akun customer setelah pengajuan disetujui.
                            </p>
                        </div>
                    {/if}

                    <div
                        class="bg-white rounded-xl p-3 border border-cyan-200 flex justify-between items-center"
                    >
                ...
                >
                    ...
                    {#if refund.status === 'menunggu_konfirmasi'}
                        ...
                        >
                            <i class="ti ti-circle-check text-base"></i> Setujui &
                            Proses Refund
                        </button>
                        <button
                    ...
                    {:else if refund.status === 'disetujui' && refund.refund_method === 'transfer'}
                        <div
                            class="p-3 bg-blue-50 border border-blue-200 rounded-xl text-xs text-blue-900 leading-relaxed font-medium mb-2"
                        >
                            <p class="font-bold flex items-center gap-1">
                                <i class="ti ti-info-circle text-base"></i> Butuh
                                Transfer Manual
                            </p>
                            <p class="mt-1">
                                Silakan lakukan transfer sebesar <strong
                                    >{fmt(refund.refund_amount)}</strong
                                > ke rekening di atas secara manual, lalu klik tombol
                    ...
                    {:else}
                        <div class="text-center py-4">
                            <i
                                class="ti {refund.status === 'selesai'
                                    ? 'ti-circle-check text-emerald-400'
                                    : 'ti-circle-x text-red-400'} text-4xl"
                            ></i>
                ...
                >
                    ...
                    <div class="space-y-3 text-xs">
                        <div class="flex gap-3">
                            ...
                            ></div>
                            <div>
                                <p class="font-bold text-slate-750">
                        ...
                        {#if refund.processed_at}
                            <div class="flex gap-3">
                                <div
                                    class="w-2 h-2 rounded-full shrink-0 mt-1 {refund.status ===
                                    'ditolak'
                                        ? 'bg-red-400'
                                        : 'bg-blue-400'}"
                                ></div>
                                <div>
                                    ...
                                    >
                                        {refund.status === 'ditolak'
                                            ? 'Ditolak'
                                            : 'Disetujui'} oleh {refund
                                            .processed_by_user?.name ?? 'Admin'}
                                    </p>
                                    <p class="text-slate-400">
                        ...
                        {#if refund.refunded_at}
                            <div class="flex gap-3">
                                <div
                                    class="w-2 h-2 rounded-full bg-emerald-400 shrink-0 mt-1"
                                ></div>
                                <div>
