                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        ...
                                        {:else if row.status === 'batal'}
                                            <span
                                                class="px-2.5 py-1 bg-rose-50 text-rose-700 text-xs font-bold rounded-lg border border-rose-100"
                                                >Batal</span
                                            >
                                        ...
                                        {:else if row.status === 'out_for_pickup'}
                                            <span
                                                class="px-2.5 py-1 bg-purple-50 text-purple-700 text-xs font-bold rounded-lg border border-purple-100"
                                                >Out for Pickup</span
                                            >
                                        {:else}
                                            <span
