<script lang="ts">
    ...
    let {
        ...
        filters = { date_from: '', date_to: '', search: '', preset: '' },
    } = $props();
...
<svelte:head>
    <title>Laporan Pelanggan — {storeName}</title>
</svelte:head>
...
<AdminLayout>
    <main class="flex-grow p-4 sm:p-8 w-full max-w-[1600px] mx-auto space-y-6 print:p-0 print:bg-white">
        ...
        <div class="hidden print:block text-center space-y-1.5 mb-6">
            ...
            <h2 class="font-outfit font-bold text-lg text-slate-700">Laporan Aktivitas Pelanggan</h2>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-5 sm:p-6 shadow-sm space-y-4 print:hidden">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-end pt-2 border-t border-slate-100">
                ...
                <div class="lg:col-span-6 space-y-1.5">
                    <label class="text-[10px] font-bold text-slate-400 uppercase tracking-wider" for="search">Cari Nama / Email</label>
                    <input
                        type="text"
                        id="search"
        ...
        >
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse responsive-table customers-report-table">
                    <thead>
                        <tr
        ...
        >
            ...
            <div class="p-6 overflow-y-auto flex-grow space-y-4">
                ...
                {:else}
                    ...
                    >
                        <table
                            class="w-full text-left border-collapse responsive-table customer-transactions-table"
                        >
                            <thead>
                                <tr
                                    class="bg-slate-50/50 text-[10px] font-bold text-slate-400 uppercase tracking-widest font-outfit border-b border-slate-100"
                            ...
                            >
                                {#each transactionsData.data as tx}
                                    ...
                                    >
                                        ...
                                        >
                                        <td class="py-3 px-4 text-slate-500" data-label="Tanggal"
                                            >{formatDate(tx.created_at)}</td
                                        >
                                        <td class="py-3 px-4" data-label="Metode Bayar">
                                            <span
...
<style>
    @media (max-width: 640px) {
        .customers-report-table td:first-child,
        .customer-transactions-table td:first-child {
            display: flex !important;
        }
        .customers-report-table td[data-label="Nama Pelanggan"],
        .customers-report-table td[data-label="Email"],
        .customer-transactions-table td[data-label="No. Transaksi"] {
