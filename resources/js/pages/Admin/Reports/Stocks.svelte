    ...
    <main class="flex-grow p-4 sm:p-8 w-full max-w-[1600px] mx-auto space-y-6 print:p-0 print:bg-white">
        ...
        >
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse responsive-table stocks-report-table">
                    <thead>
                        <tr
...
<style>
    @media (max-width: 640px) {
        .stocks-report-table td:first-child {
            display: flex !important;
        }
        .stocks-report-table td[data-label="Nama Produk / Varian"] {
