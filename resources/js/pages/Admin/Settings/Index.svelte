<script lang="ts">
    ...
    const settingsTabs = [
        ...
        { id: 'loyalty', label: 'Loyalty Poin', icon: 'ti-coin' },
                            ...
                            {#if env_keys.show_checkout_settings !== false}
                                ...
                                <div class="space-y-2">
                                    ...
                                    {#if form.self_pickup_enabled}
                                        <div class="pl-6 border-l-2 border-slate-100 mt-2 space-y-2" transition:slide>
                                            <InputCurrency
                                ...
                                <div class="space-y-2">
                                    ...
                                    {#if form.store_courier_enabled}
                                        <div class="pl-6 border-l-2 border-slate-100 mt-2 space-y-3" transition:slide>
                                            <div class="space-y-1">
                                            ...
                                            {:else if form.store_courier_type === 'radius_tiered'}
                                                <div class="space-y-4">
                                                    <div class="flex justify-between items-center">
                                                        <span class="text-xs font-bold text-slate-500 uppercase tracking-wider block">Aturan Jarak & Biaya (Bertingkat)</span>
                                                        <button
                                                            type="button"
                                                                ...
                                                                <div class="flex items-center gap-3 bg-white p-3 rounded-xl border border-slate-200/50 shadow-sm" transition:slide>
                                                                    <div class="flex-grow grid grid-cols-2 gap-3.5">
                                                                        <div class="space-y-1">
                                                                            ...
                                                                            <div class="relative">
                                                                                <input type="number" min="0.1" step="0.1" bind:value={tier.max_distance} class="w-full px-3 py-1.5 border border-slate-200 rounded-lg text-xs focus:ring-1 focus:outline-none transition font-sans" placeholder="Contoh: 5" required />
                                                                        ...
                                                                        <div class="space-y-1">
                                                                            ...
                                                                            <div class="relative">
                                                                                ...
                                                                                <input type="number" min="0" bind:value={tier.fee} class="w-full pl-9 pr-3.5 py-1.5 border border-slate-200 rounded-lg text-xs focus:ring-1 focus:outline-none transition font-sans" placeholder="Contoh: 10000" required />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <button type="button" onclick={() => removeCourierTier(index)} class="p-2.5 text-rose-500 hover:bg-rose-50 rounded-xl transition self-end cursor-pointer" title="Hapus Aturan">
