        ...
        <div class="space-y-6">
            ...
            >
                {#if movements.data.length === 0}
                    ...
                    >
                        <i
                            class="ti ti-package-off text-5xl text-slate-200 mb-3"
                        ></i>
                ...
                {:else}
                                ...
                                {#each movements.data as mov}
                                    ...
                                    >
                                        ...
                                        <td class="py-6 px-6">
                                            ...
                                            >
                                                <i
                                                    class="ti {typeStyle.icon} text-xs"
                                                ></i>
                                                {typeLabels[mov.type] ??
                                                    mov.type}
                                            </span>
                                        ...
                                        <td class="py-6 px-6 text-center">
                                            <span
                                                ...
                                                >{mov.stock_before}</span
                                            >
                                        </td>
                                        <td class="py-6 px-6 text-center">
                                            <span
                                                class="text-sm font-bold text-slate-700"
                                                >{mov.stock_after}</span
                                            >
                                        </td>
                                        <td class="py-6 px-6">
                                            {#if mov.transaction}
                                                <a
                                                    href="/admin/transactions/{mov
                                                        .transaction.id}"
                                        ...
                                        <td class="py-6 px-6">
                                            <span
                                                class="text-xs text-slate-500 font-bold whitespace-pre-wrap break-words"
                                                >{mov.notes ?? '-'}</span
                                            >
                                        </td>
                                        <td class="py-6 px-6">
                    ...
                    {#if movements.last_page > 1}
                        ...
                        >
                            ...
                            >
                                Menampilkan {movements.from}–{movements.to} dari {movements.total}
                                data
                            </p>
