...
<svelte:head>
    <title>Atur Pengiriman & Dimensi — Admin</title>
</svelte:head>
...
<AdminLayout>
    <main class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-semibold tracking-tight text-slate-900">Atur Pengiriman & Dimensi</h1>
                <p class="mt-0.5 text-sm text-slate-550">Kelola berat pengiriman dan dimensi fisik (panjang, lebar, tinggi) produk & varian secara massal</p>
            </div>
        </div>
        ...
        <div class="flex border-b border-slate-200 w-full">
            ...
            >
                ...
                <div
                    class="text-xs font-semibold text-slate-550 uppercase tracking-wider"
                >
                            ...
                            >
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="px-2 py-0.5 bg-slate-100 text-slate-550 font-semibold text-[10px] uppercase tracking-wider rounded-md"
                                ...
                                >
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        {#each product.variants as variant (variant.id)}
                                            <div
                                                class="bg-white border border-slate-200 rounded-xl p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-6 shadow-sm"
                                            >
                                                <!-- Variant Name / SKU -->
                                                <div
