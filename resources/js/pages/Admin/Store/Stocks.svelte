...
<AdminLayout>
    <main class="w-full max-w-[1600px] mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-semibold tracking-tight text-slate-900">Atur Stok</h1>
                <p class="mt-0.5 text-sm text-slate-550">Kelola stok, batas minimum (alert), dan minimum pembelian produk & varian secara massal</p>
            </div>
        </div>
                        ...
                        <table class="w-full text-sm responsive-table">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                {#each localProducts as product (product.id)}
                                    ...
                                    >
                                        <!-- Product Name -->
                                        <td class="px-5 py-4" data-label="Info Produk">
                                            <div
                                            ...
                                            >
                                                ...
                                                <div class="min-w-0">
                                                    ...
                                                    <span
                                                        class="px-1.5 py-0.5 bg-slate-100 text-slate-505 font-semibold text-[10px] uppercase tracking-wider rounded-md"
                                                    >
                                        ...
                                        <!-- Stock -->
                                        <td class="px-4 py-4" data-label="Stok Saat Ini">
                                        ...
                                        <!-- Min Stock -->
                                        <td class="px-4 py-4" data-label="Batas Min. (Alert)">
                                            {#if !product.has_variants || !product.use_custom}
                                                <Input
                                                    bind:value={
                                                        product.min_stock
                                        ...
                                        <!-- Min Purchase -->
                                        <td class="px-4 py-4" data-label="Min. Beli">
                                            {#if !product.has_variants || !product.use_custom}
                                                <Input
                                                    bind:value={
                                        ...
                                        <!-- Options -->
                                        <td class="px-4 py-4" data-label="Opsi">
                                            <div
                                    ...
                                    {#if product.has_variants && product.use_custom && product.expanded}
                                        ...
                                        {#each product.variants as variant (variant.id)}
                                            <tr
                                                class="variant-row bg-slate-50/60 hover:bg-brand-blueRoyal/2 transition-colors"
                                            >
                                                <!-- Variant Name -->
                                                <td class="pl-12 pr-4 py-3" data-label="Varian">
                                                    <div
                                                ...
                                                <!-- Variant Stock -->
                                                <td class="px-4 py-3" data-label="Stok Saat Ini">
                                                    <Input
                                                        bind:value={
                                                            variant.stock
                                                        }
                                                ...
                                                <!-- Variant Min Stock -->
                                                <td class="px-4 py-3" data-label="Batas Min. (Alert)">
                                                    <Input
                                                        bind:value={
                                                            variant.min_stock
                                                        }
                                                ...
                                                <td class="px-4 py-3" data-label="Min. Beli">
                                                    <Input
                                                        bind:value={
                                                ...
                                                <td class="px-4 py-3" data-label="Opsi">
                                                    <Toggle
                                                        bind:checked={
