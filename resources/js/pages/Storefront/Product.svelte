                                        ...
                                        {:else if slide.type === '3d'}
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div class="absolute bottom-3 left-2 right-2 flex justify-between items-center gap-1.5 z-30">
                                                        <button
                                                            type="button"
                                                        ...
                                                        >
                                                            <i class="ti ti-camera text-[11px]"></i>
                                                            Buka Kamera AR
                                                        </button>
                                                        <button
                                                            slot="ar-button"
                                                        ...
                                                        >
                                                            <i class="ti ti-augmented-reality text-[11px]"></i>
                                                            Lihat di Ruangan
                                                        </button>
                                                    </div>
                                                </model-viewer>
