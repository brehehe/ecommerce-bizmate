        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8">
            ...
            >
                ...
                <div class="flex flex-col gap-3">
                    ...
                    {#if activePromoRule && activePromoRule.min_qty > 1 && !isPromoStockExhausted}
                        <div
                ...
                <div class="flex flex-col gap-0 divide-y divide-slate-100">
                        ...
                        <div class="py-4 hidden md:block">
                            {#if currentPrice > 0}
                                ...
                                >
                                    ...
                                    {#if originalPrice && originalPrice > currentPrice}
                                        <span
                                            class="text-sm sm:text-base text-red-600 line-through font-bold"
                                        >
                                            {fmt(originalPrice)}
                                        </span>
                                        <span
                    ...
                    {:else if bundlingPromos && bundlingPromos.length > 0}
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {#if gift.discount_type === 'free'}
                                                                ...
                                                                <span
                                                                    class="text-[9px] text-red-600 line-through font-bold font-mono"
                                                                >
                                                                    {fmt(
                                                                        gift.product_price,
                                                                    )}
