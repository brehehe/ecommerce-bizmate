...
function createSafetyTransactionWithStatus(string $status): array
{
...
test('admin cannot revert transaction status to previous step', function () {
    ['transaction' => $transaction, 'admin' => $admin] = createSafetyTransactionWithStatus('dikirim');
...
test('admin can progress transaction status forward', function () {
    ['transaction' => $transaction, 'admin' => $admin] = createSafetyTransactionWithStatus('diproses');
...
test('bulk status update skips reversion of statuses', function () {
    ...
    ['transaction' => $trx1] = createSafetyTransactionWithStatus('diproses');
    ['transaction' => $trx2] = createSafetyTransactionWithStatus('dikirim');
